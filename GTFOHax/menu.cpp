...
{
    ImGui::Checkbox("上帝模式", &Player::godmodeToggleKey.toggledOn);
    ImGui::SameLine();
    ...
    ImGui::Checkbox("无限子弹", &Player::infiAmmoToggleKey.toggledOn);
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
    ...
    ImGui::Checkbox("胶枪无CD", &Player::glueInstantToggleKey.toggledOn);
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
    ...
    ImGui::Checkbox("快速侵入锁", &Player::instaHackToggleKey.toggledOn);
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
    ...
    ImGui::Checkbox("无后座", &Player::noRecoilToggleKey.toggledOn);
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
    ...
    ImGui::Checkbox("无扩散", &Player::noSpreadToggleKey.toggledOn);
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
    ...
    ImGui::Checkbox("无视角摇晃", &Player::noShakeToggleKey.toggledOn);
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
    ...
    if (ImGui::Button("获得工具弹药"))
        Player::GiveLocalClassAmmo();
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
    ImGui::PushID("GiveClassAmmoHotkey");
    ImGui::Hotkey("", Player::giveClassAmmoKey);
    ImGui::PopID();

    if (ImGui::Button("补充弹药包"))
        Player::GiveLocalResourcePackRel();
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
    ImGui::PushID("GiveResourcePackRelKey");
    ImGui::Hotkey("", Player::giveResourcePackRelKey);
    ImGui::PopID();

    if (ImGui::Button("补充消耗品"))
        Player::GiveLocalCurrentConsumable();
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
    ImGui::PushID("GiveCurrentConsumableKey");
    ImGui::Hotkey("", Player::giveCurrentConsumableKey);
    ImGui::PopID();
}

void RenderAgentESPSection(ESP::AgentESPSection& section)
{
    ImGui::Checkbox(("开启##EnemyCheckbox" + section.type).c_str(), &section.show);
    ...
    if (ImGui::TreeNode("方框"))
    {
        ...
        ImGui::Checkbox(("血条文本##Enemy" + section.type).c_str(), &section.healthBarText);
        ImGui::SameLine();
        ...
        ImGui::Checkbox(("血条满血文本##Enemy" + section.type).c_str(), &section.healthBarTextFull);
    ...
    {
        ImGui::Checkbox(("开启##EnemyInfo" + section.type).c_str(), &section.showInfo);
        ImGui::SameLine();
        ...
        ImGui::Checkbox(("血量##EnemyHealth" + section.type).c_str(), &section.showHealth);
    ...
    {
        ImGui::Checkbox(("开启##EnemySkeleton" + section.type).c_str(), &section.showSkeleton);
        ImGui::SameLine();
...
void RenderTabESP()
{
    ImGui::Checkbox("物品透视", &ESP::worldESPToggleKey.toggledOn);
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
...
void RenderTabAimbot()
{
    ...
    ImGui::Checkbox("按住时自瞄", &Aimbot::settings.holdOnly);
    ImGui::SameLine();
    ...
    ImGui::Checkbox("仅瞄准可见敌人##EnemyAimbot", &Aimbot::settings.visibleOnly);
    ImGui::Checkbox("瞄准护甲##EnemyAimbot", &Aimbot::settings.aimAtArmor);
    ...
    ImGui::Checkbox("FOV 范围##EnemyAimbot", &Aimbot::settings.renderFOV);
    ImGui::SameLine();
    ImGui::PushItemWidth(-25);
...
void RenderTabMisc()
{
    ImGui::Checkbox("去雾气", &Player::noFogToggleKey.toggledOn);
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
    ...
    ImGui::Checkbox("世界高亮", &Player::fullBrightToggleKey.toggledOn);
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
    ...
    ImGui::Checkbox("扫描无CD", &Player::quickBioToggleKey.toggledOn);
    ImGui::SameLine();
    ImGui::SetCursorPosX(160);
    ImGui::PushID("QuickBioHotkey");
    ImGui::Hotkey("", Player::quickBioToggleKey);
    ImGui::PopID();

    ImGui::Hotkey("显示菜单快捷键", G::menuKey);
...
void RenderTabConfig()
{
    ...
    ImGui::Text("请认准咸鱼：爱吃糯米煎饼的顾颜");
    ImGui::Text("如果你在其他途径得到该辅助说明你被骗了");
}
