...
void Config::Save()
{
    try
    {
        json j = json
        {
            ...
            //("QuickBioToggleKey", Player::quickBioToggleKey),
            {"GiveHealthKey", Player::giveHealthKey},
            {"GiveDisinKey", Player::giveDisinKey},
            {"GiveAmmoKey", Player::giveAmmoKey},
            {"GiveClassAmmoKey", Player::giveClassAmmoKey},
            {"GiveResourcePackRelKey", Player::giveResourcePackRelKey},
            {"GiveCurrentConsumableKey", Player::giveCurrentConsumableKey},
...
void Config::Load()
{
    ...
    try
    {
        ...
        //JSON_GET("QuickBioToggleKey", Player::quickBioToggleKey);
        ...
        JSON_GET("GiveClassAmmoKey", Player::giveClassAmmoKey);
        JSON_GET("GiveResourcePackRelKey", Player::giveResourcePackRelKey);
        JSON_GET("GiveCurrentConsumableKey", Player::giveCurrentConsumableKey);
