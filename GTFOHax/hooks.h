...
namespace Hooks
{
    ...
    void hkLightBase_UpdatePriority(app::LightBase* __this, app::Vector3 cameraPosition, app::Plane__Array* cameraFrustum, MethodInfo* method);
    void hkEnemyScanner_UpdateTagProgress(app::EnemyScanner* __this, int32_t maxTags, MethodInfo* method);
}
